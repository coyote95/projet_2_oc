...
def csv_file(products, csv_name):
    ...
    with open(f"{file_title}.csv", "w+", newline="", encoding="utf-8") as fichier:
        fieldnames = ["product_page_url", "universal_product_code(upc)", "title", "price_including_tax_£",
                      "price_excluding_tax_£", "number_available", "product_description", "category", "review_rating",
                      "img_url"]
